...
function showCartProducts() {
  ...
  */
  if (cartProducts !== null && cartProducts.length > 0) {
                   ...
                   <th scope="row" class="border-0">
                        <div class="p-2">
                            ...
                            <div class="ml-3 d-inline-block align-middle">
                                ...
                                <div class="price-sm"><strong>$ ${product.product_price} x ${product.product_quantity}</strong></div>
                            </div>
                        </div>
                    </th>
                    <td class="border-0 align-middle price"><strong>$ ${product.product_price} x ${product.product_quantity}</strong></td>
    ...
    document.querySelector(".sub-total-bill").innerHTML = totalBill + " $";
    document.querySelector(".total-bill").innerHTML = totalBill + " $";

    //Show the sub-total and total bill in checkout popup
    document.querySelector(".checkout-quantity").innerHTML = totalQuantity;
    document.querySelector(".checkout-total-bill").innerHTML = totalBill + " $";
    let discountBill = totalBill - ((totalBill * 10) / 100);    // calculating discount
    document.querySelector(".checkout-discount-bill").innerHTML = discountBill + " $";
